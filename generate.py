...
.btn-email { display: inline-flex; align-items: center; gap: 6px; background: var(--accent); color: #15161b;
...
.btn-email:hover { filter: brightness(.92); transform: translateY(-1px); }
